...
const TEAM_MEMBERS = [
  ...
  {
    name: "DEMILADE OGUNDEKO",
    role: "SPONSORSHIP AND INDUSTRY RELATIONS LEAD",
  },
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="hero-top-bg">
        ...
        {/* Hero Section */}
        <section className="relative px-4 pt-8 pb-20 text-white sm:px-6 sm:pt-10 sm:pb-24 lg:px-8 lg:pt-14 lg:pb-32">
          <div className="relative mx-auto max-w-7xl text-center">
            <div className="font-anaheim mb-6 inline-block rounded bg-[#D97706] px-4 py-2 font-bold text-white sm:mb-8 sm:px-6">
              ABOUT SST MAKERSPACE
            </div>

            <h1 className="font-urbanist mb-6 text-3xl leading-tight font-bold sm:text-5xl lg:text-7xl">
              UNVEILING OUR MISSION,
              <br />
              VISION & TEAM
            </h1>
            <p className="font-poppins mx-auto mb-10 max-w-3xl text-base text-gray-300 italic sm:mb-12 sm:text-lg">
      ...
      <section className="bg-white px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <h2 className="font-urbanist mb-8 text-3xl font-bold text-[#D97706] sm:mb-10 sm:text-4xl lg:mb-12 lg:text-5xl">
            WHO WE ARE
          </h2>
          ...
          <div className="mb-6 grid gap-6 md:grid-cols-2">
            <div className="order-1 rounded-3xl bg-[#D97706] p-6 text-white sm:p-8 lg:p-10">
              <div className="mb-6 flex items-baseline gap-4">
                <span className="font-urbanist text-4xl font-bold sm:text-5xl lg:text-6xl">
                  01
                </span>
                <span className="font-urbanist text-2xl font-bold sm:text-3xl">
                  GOAL
                </span>
              </div>
              <p className="font-poppins text-base leading-relaxed sm:text-lg">
                To foster innovation and creativity among students, equipping
            ...
            <div className="order-3 row-span-1 flex flex-col justify-center rounded-3xl bg-[#92400E] p-6 text-white sm:p-8 md:order-2 md:row-span-2 lg:p-10">
              ...
              <p className="font-poppins text-base leading-relaxed sm:text-lg">
                We empower Africa&apos;s innovators through hands-on,
                interdisciplinary projects that turn ideas into practical,
            ...
            <div className="order-2 rounded-3xl bg-[#7C3AED] p-6 text-white sm:p-8 md:order-3 lg:p-10">
              ...
              <p className="font-poppins text-base leading-relaxed sm:text-lg">
                To create a generation of problem-solvers and innovators who can
      ...
      <section className="bg-gray-50 px-4 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-6xl rounded-3xl bg-white p-6 shadow-sm sm:p-8 lg:p-12">
          <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
            <div>
              <h2 className="font-urbanist mb-4 text-3xl font-bold text-[#7C3AED] sm:mb-6 sm:text-4xl">
                OUR ALIGNMENT WITH THE SDG GOALS
              </h2>
              <p className="font-poppins leading-relaxed text-gray-600">
                At SST Makerspace, we are committed to driving innovation and
                building a hardware inclusive future. Our mission aligns with
                the United Nations Sustainable Development Goals to create
                lasting change.
              </p>
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="rounded-2xl bg-[#C5192D] p-5 text-white sm:p-6">
                ...
                <div className="font-anaheim mb-2 text-sm leading-snug sm:text-base">
                  QUALITY EDUCATION
                </div>
                <svg
              ...
              <div className="rounded-2xl bg-[#FD6925] p-5 text-white sm:p-6">
                ...
                <div className="font-anaheim mb-2 text-xs">
      ...
      <section className="bg-white px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <h2 className="font-urbanist mb-8 text-3xl font-bold text-[#7C3AED] sm:mb-10 sm:text-4xl lg:mb-12 lg:text-5xl">
            MEET OUR TEAM
          </h2>

          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
            {TEAM_MEMBERS.map((member, idx) => (
              <div key={idx} className="group relative min-w-0">
                ...
                <div className="rounded-2xl bg-[#7C3AED] p-4 text-center text-white sm:p-5">
                  <div className="font-urbanist text-xl leading-tight font-bold break-words sm:text-2xl">
                    {member.name}
                  </div>
                  <div className="font-anaheim mt-1 text-base leading-tight break-words italic sm:text-lg">
                    {member.role}
                  </div>
                </div>
              </div>
      ...
      <section className="relative bg-white px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="absolute top-0 left-0 hidden h-full w-20 md:block lg:w-32">
          <svg viewBox="0 0 100 400" className="h-full w-full">
            <path d="M 0 0 Q 50 100 0 200 Q 50 300 0 400" fill="#7C3AED" />
          </svg>
        </div>
        <div className="absolute top-0 right-0 hidden h-full w-20 md:block lg:w-32">
          <svg viewBox="0 0 100 400" className="h-full w-full">
            <path
              d="M 100 0 Q 50 100 100 200 Q 50 300 100 400"
              fill="#D97706"
            />
          </svg>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-4xl rounded-3xl bg-white p-6 shadow-xl sm:p-10 lg:p-16">
          <h2 className="font-urbanist mb-4 text-center text-3xl font-bold text-[#7C3AED] sm:mb-6 sm:text-4xl lg:text-5xl">
            Want to join our team?
          </h2>
          <p className="font-poppins mx-auto mb-8 max-w-2xl text-center text-gray-600">
            We are always looking for students and collaborators who want to
            build, test, and ship impactful hardware projects. Join the team to
            contribute your skills and learn by doing.
          </p>
          <div className="flex justify-center">
            <Button className="font-urbanist h-auto bg-[#7C3AED] px-6 py-4 text-base font-bold text-white hover:bg-[#6D28D9] sm:px-8 sm:py-6 sm:text-lg">
              BE A VOLUNTEER
            </Button>
          </div>
        </div>
